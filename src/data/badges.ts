...
export const BADGES: Badge[] = [
  ...
  { id: 'mode-switcher', name: 'Mode Shifter', description: 'Finish Module 3 and know when the work belongs in code or on screen.', icon: 'M3', criteria: 'module-3' },
  ...
  { id: 'super-app-mapper', name: 'Super App Navigator', description: 'Finish Module 9 and see how the Codex surfaces fit together.', icon: 'M9', criteria: 'module-9' },
